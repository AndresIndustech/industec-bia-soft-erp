...
la bandeja, el historial y el formulario del técnico salen de la base (`verificar_bandeja.py`). Lo que
sigue, en orden: T2.13.5, T2.13.4 y la migración 008 de la emisión.
