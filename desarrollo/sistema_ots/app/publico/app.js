    ...
    selEq.addEventListener('change', function () {
      ...
      if (ficha && !campoMarca.value && !campoModelo.value && !campoSerie.value) {
        if (ficha.sin_placa) {
          ...
          mostrarNotaFicha('En la última orden de este equipo se marcó «sin placa o ilegible». Corrígelo si ahora sí se puede leer.');
          ...
          var fecha = ficha.en ? String(ficha.en).slice(8, 10) + '/' + String(ficha.en).slice(5, 7) : 'una orden anterior';
          mostrarNotaFicha('Datos de la última orden (' + fecha + (ficha.por ? ', ' + ficha.por : '')
