...
|---|---|---|---|
| **T2.21 · Cerrar la cadena del correo** (T2.21.1 y T2.21.2, en simulación) | Conversación "arranque del plan" (estación) | 2026-09-18 | Solo lectura por ahora: EXAMINE + `BODY.PEEK[]` sobre `Trash` e `INFORMES OT`, y simulación de `t2_18_rescatar_buzon.py --origen`. Nada de `--ejecutar` (queda para cuando Andrés apruebe) |
